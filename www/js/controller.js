...
uver.controller('pickupCtrl', ['$scope', '$rootScope', '$location', '$http', '$compile','$uibModal','$interval', 'pickUpPlace','serve','orderService',
    function($scope, $rootScope, $location, $http, $compile, $uibModal,$interval, pickUpPlace, serve, orderService) {
        ...
        $scope.map_image    = 'https://maps.googleapis.com/maps/api/staticmap?key=AIzaSyA4cvpCYxiYr2gbDptRIEAY4nF9dF0j--s&center='+$scope.lat+','+$scope.lng +'&zoom=13&scale=1&size=300x110&maptype=roadmap&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7C'+$scope.lat+','+$scope.lng;
